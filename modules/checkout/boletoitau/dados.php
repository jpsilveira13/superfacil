<?php
/*
	Arquivo de Manipulacao de Modulos de Pagamento / Frete
	Desenvolvido por :  Get Store - Soluções em Ecommerce
...
// Modulo
function fecthModule($modulo, $alvo){
	$prefixotabela = $GLOBALS['ISC_CFG']["tablePrefix"];
