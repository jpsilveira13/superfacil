<?php
	...
	define('DOMAIN_TOKEN', $host);

	// What version are we running?
	define('PRODUCT_ID', 'ISC');
	define('OFFICIAL_PRODUCT_VERSION', '2.0');
	define('PRODUCT_VERSION', '7.0.0');
	define('PRODUCT_VERSION_CODE', 7000);
	...
	$GLOBALS['ProductVersion'] = OFFICIAL_PRODUCT_VERSION;
