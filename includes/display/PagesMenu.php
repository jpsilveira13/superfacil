		...
		public function SetPanelSettings()
		{
			...
			if(!empty($pages) && isset($pages[0])) {
				foreach($pages[0] as $page) {
					...
					//enable package link if custom product package addon is enabled
					...
					");
					$count = $GLOBALS['ISC_CLASS_DB']->FetchOne($pull_customprodpackage);
					if($count != 0 ){
						$GLOBALS['packages_link'] = '<a href="%%GLOBAL_ShopPath%%/customprodpackage.php">Packages</a>';
					}
