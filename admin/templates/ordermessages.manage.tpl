	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
			...
			<table id="IntroTable" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					<td class="Intro" valign="top">
						<input type="button" name="IndexAddButton" value="{% lang 'CreateMessage' %}" id="IndexCreateButton" class="btn" onclick="document.location.href='index.php?ToDo=createOrderMessage&amp;orderId={{ OrderId|raw }}'" />
						...
						&nbsp;<input type="button" name="IndexReturnButton" value="{% lang 'ViewOrders' %}" class="btn" onclick="document.location.href='index.php?ToDo=viewOrders'" />
					</td>
				</tr>
			</table>
			<br />
		...
		<td style="display: {{ DisplayGrid|raw }}">
			...
			<table class="GridPanel" cellspacing="0" cellpadding="0" border="0" id="IndexGrid" style="width:100%; border: 1px solid #ddd;">
			<tr class="Heading3">
