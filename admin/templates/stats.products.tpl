			...
			<div id="dateBlock" style="padding:5px 0px 5px 10px" class="Text FloatLeft">
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td style="background: #eee;" class="dateField">{% lang 'DateRange' %}:</td>
						<td style="background: #eee; padding: 3px 5px;" width="1" class="dateField">
						...
						<td style="background: #eee;" class="dateField">
							...
							<select name="Calendar[From][Day]" style="margin-bottom:3px">
								{{ OverviewFromDays|raw }}
							</select>
							<select name="Calendar[From][Mth]" style="margin-bottom:3px">
								{{ OverviewFromMonths|raw }}
							</select>
							<select name="Calendar[From][Yr]" style="margin-bottom:3px">
								{{ OverviewFromYears|raw }}
							</select>
							<span class=body>{% lang 'To1' %}</span>
							<select name="Calendar[To][Day]" style="margin-bottom:3px">
								{{ OverviewToDays|raw }}
							</select>
							<select name="Calendar[To][Mth]" style="margin-bottom:3px">
								{{ OverviewToMonths|raw }}
							</select>
							<select name="Calendar[To][Yr]" style="margin-bottom:3px">
								{{ OverviewToYears|raw }}
							</select>
							</span>&nbsp;
						</td>
						...
						<td class="GoButton" style="background: #eee; padding: 3px 5px;"><input type="submit" value="Ok" class="btn" /></td>
						<td>
							<div id="ShowHideVariationsButtonContainer">
								<input id="ShowHideVariationsButton" type="button" class="btn" onclick="ChangeProductsByInventoryVariations();return false;" value="{% lang 'HideVariations' %}" />
							</div>
						</td>
					</tr>
				</table>
