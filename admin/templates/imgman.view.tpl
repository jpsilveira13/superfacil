...
var AdminImageManager = {
	...
	GetImageRow: function() {
		...
		row += ' | <a id="%%image_id%%_download" href="index.php?ToDo=downloadImage&image=%%image_realname%%">{% lang 'imageManagerDownload' %}</a><br /> ';
		row += '  {%lang 'imageManagerSize' %}: %%image_size%% <br />{%lang 'imageManagerDimensions' %}: %%image_dimensions%%px<br />';
		row += '  <input type="button"  class="btn btn-delete" id="%%image_id%%_delete" value="{% lang 'imageManagerDelete' %}" style="width: 150px; margin-top: 4px; margin-bottom: 14px; " />';
		row += '</div>';
...
<table class="OuterPanel" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<p>
			...
			<input id="btnUpload" type="button" class="btn" value="{% lang 'imageManagerUploadImages' %}" style="width: 130px;" />&nbsp;<input id="deleteButton" type="button" value="{% lang 'imageManagerDeleteSelected' %}"  class="btn btn-delete"  style="display: " /><br /><br />
		</p>
</td>
</tr><tr><td>
...
<div style="">
	...
	<div style="float: right; padding-bottom: 7px;">
		<select name="PerPage" class="Field" onChange="ChangeImageManagerPaging(this, '{{ PageNumber|raw }}');">
		...
		<select name="SortBy" class="Field" onChange="ChangeImageManagerSorting(this, '{{ PageNumber|raw }}');">
