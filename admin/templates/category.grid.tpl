<ul class="SortableList CategoryList" {% if isChild %}id="ChildCats_{{ categoryId }}"{% else %}id="CategoryList" style="border: 1px solid #ccc;border-top: none;"{% endif %} {% if isChild %}style="padding-left: 30px; padding-right: 0px;"{% endif %}>
