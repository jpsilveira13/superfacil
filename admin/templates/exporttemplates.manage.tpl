		...
		<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
			...
			<tr>
				<td class="Intro">
					...
					{{ Message|raw }}
					<p>
						<input type="button" name="IndexAddButton" value="{% lang 'AddExportTemplate' %}" id="IndexCreateButton" class="btn" onclick="document.location.href='index.php?ToDo=createExportTemplate'" /> &nbsp;<input type="button" name="IndexDeleteButton" value="{% lang 'DeleteSelected' %}" id="IndexDeleteButton" class="btn btn-delete" onclick="ConfirmDeleteSelected()" {{ DisableDelete|raw }} />
					</p>
				</td>
			</tr>
			<tr>
