...
{% block intro %}
	<div id="froogleExportStep1">
		...
		<div id="froogleExportStep1Warning" class="MessageBox MessageBoxInfo">Por favor, selecione o seu país de destino. Seu feed XML vai ser adaptado para atender às exigências do país selecionado.</div>
	...
	<div id="froogleExportStep2" style="display:none;">
		<p>
			...
			<span id="froogleExportTargetCountry"></span> (<a href="#" class="onClickChangeFroogleTargetCountry">modificar</a>)
		</p>
		{{ parent() }}
	</div>
