	...
	<table class="OuterPanel">
	  <tr>
		...
		<td class="Intro">
			...
			{{ Message|raw }}
			<p>
				<input type="submit" name="SubmitButton1" style="width:100px" value="{% lang 'StartBackup' %}" class="btn btn-atualize" onclick="StartBackup(); return false;">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()">
			</p>
		</td>
	  </tr>
		<tr>
			<td>
			  <table class="Panel">
				...
				<tr>
					<td class="Gap">&nbsp;</td>
					<td class="Gap"><input type="submit" name="SubmitButton1" style="width:100px" value="{% lang 'StartBackup' %}" class="btn btn-atualize" onclick="StartBackup(); return false;">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()">
					</td>
				</tr>
			 </table>
			</td>
