	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
		...
		<td class="Intro">
			...
			<td class="Intro" valign="top">
				<input type="button" name="IndexAddButton" value="{% lang 'AddBrand' %}" id="IndexCreateButton" class="btn" onclick="document.location.href='index.php?ToDo=addBrand'" /> &nbsp;<input type="button" name="IndexDeleteButton" value="{% lang 'DeleteSelected' %}" id="IndexDeleteButton" class="btn btn-delete" onclick="ConfirmDeleteSelected()" {{ DisableDelete|raw }} />
			</td>
			<td class="SmallSearch" align="right">
				...
				<tr>
					...
					<td nowrap>
						...
						<input type="submit" value="Procurar" name="SearchButton" style="padding-left: 10px; vertical-align: top;" id="SearchButton" class="btn" />
					</td>
					</form>
				</tr>
				<tr>
