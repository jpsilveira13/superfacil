		...
		<div id="settingsTab">
			<form action="index.php" method="post" id="taxZoneForm" accept-charset="utf-8">
				...
				<p class="intro">
					...
					ou <a href="#" class="cancelLink">{{ lang.Cancel }}</a>
				</p>
		...
		{% if taxZone.id %}
			<div id="taxRatesTab">
				...
				<form action="index.php" method="post" accept-charset="utf-8">
					...
					<p class="intro">
						<input type="button" value="{{ lang.AddATaxRateButton }}" class="addTaxRateButton btn" />
						<input type="submit" value="{{ lang.DeleteSelected }}" class="deleteTaxRatesButton btn btn-delete" />
					</p>
