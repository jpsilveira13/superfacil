		...
		<tr>
			<td>
			  <table class="Panel">
				...
				<tr>
					...
					<td>
						<select name="bannerloc" id="bannerloc" class="Field150">
							...
							<option value="middle" {{ IsLocationMiddle|raw }}>{% lang 'MiddleOfPage' %}</option>
							<option value="bottom" {{ IsLocationBottom|raw }}>{% lang 'BottomOfPage' %}</option>
							<option value="right" {{ IsLocationRight|raw }}>Lado Direito</option>
							<option value="left" {{ IsLocationLeft|raw }}>Lado Esquerdo</option>
						</select>
				...
				<tr>
					<td class="Gap"><input type="submit" name="SubmitButton1" value="{% lang 'Save' %}" class="btn">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()">
					</td>
				</tr>
		</tr>
	</table>
