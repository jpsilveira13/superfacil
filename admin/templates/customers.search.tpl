		...
		<tr>
			<td>
			 ...
			 <table>
			 	<tr>
					<td class="Gap">
						<p><input type="submit" name="SubmitButton1" value="{% lang 'Search' %}" class="btn">&nbsp; 
						<input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()"></p>
					</td>
				</tr>
			 </table>
			</td>
