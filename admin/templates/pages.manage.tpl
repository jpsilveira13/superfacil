	<div class="BodyContainer">
		...
		<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
			...
			<td class="Intro">
				...
				<p class="Intro">
					<input type="button" name="IndexAddButton" value="{% lang 'CreatePage' %}" id="IndexCreateButton" class="btn" onclick="document.location.href='index.php?ToDo=createPage'" /> &nbsp;
			...
			<td>
				<div id="div0" style="display: {{ DisplayGrid|raw }}">
					{{ NoPagesMessage|raw }}
					<table class="GridPanel SortablePanel" cellspacing="0" cellpadding="0" border="0" style="width:100%; margin-top:10px; border: 1px solid #ddd;">
						<tr class="Heading3">
