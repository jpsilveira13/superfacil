	...
	<table id="Table13" cellSpacing="0" cellPadding="0" width="100%">
		...
		<td class="Intro">
			...
			<td class="Intro" valign="top">
				<input type="button" value="Incluir um pedido" class="btn" onclick="document.location.href='index.php?ToDo=addOrder'">
				&nbsp;
				{% if disableOrderExports %}
					<input type="button" value="{% lang 'ExportTheseOrders' %}" disabled="disabled" class="SmallButton PopDownMenu btn btn-atualize" /><br />
				{% else %}
					<input type="button" value="{% lang 'ExportTheseOrders' %}" id="OrderExportMenuButton" class="SmallButton PopDownMenu btn btn-atualize" /><br />
				{% endif %}
				<br />
				<div style="display: {{ DisplayGrid|raw }}">
					...
					<input type="button" id="OrderActionButton" name="OrderActionButton" value="{% lang 'OrderActionButton' %}" class="btn" style="min-width:40px;" onclick="HandleOrderAction()" />
				</div>
			</td>
					...
					<table id="Table16" style="display:{{ DisplaySearch|raw }}">
						<tr>
							<td class="text" nowrap align="right">
								...
								<input type="submit" name="SearchButton" value="Procurar" class="btn" id="SearchButton" />
							</td>
						</tr>
						<tr>
							<td nowrap>
