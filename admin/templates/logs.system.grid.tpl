<form method="post" id="LogForm" action="index.php?ToDo=systemLog" onsubmit="return SearchSystemLog(this);">
	...
	<table id="SystemLogOptions" class="IntroTable" cellspacing="0" cellpadding="0" width="100%">
		<tr>
			<td class="Intro" style="padding-top: 10px;">
				...
				<input type="button" name="DeleteAll" value="{% lang 'DeleteAll' %}" class="btn btn-atualize" onclick="ConfirmDeleteAll()" {{ DisableDelete|raw }}  />
			</td>
			...
			<td width="1" style="padding-left: 5px;vertical-align: bottom;">
				<input id="SearchButton" type="submit" class="btn" value="Procurar" name="SearchButton" />
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
	...
	<table class="GridPanel SortableGrid" cellspacing="1" cellpadding="2" border="0" style="width:100%; border: 1px solid #ddd;">
		<tr class="Heading3">
