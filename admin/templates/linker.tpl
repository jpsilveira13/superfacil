...
<div id="ModalContent" class="linker">
		...
		<div class="panel_wrapper StoreLinker">
			...
			{% if 'product' in tabs %}
				<div id="product_tab" class="panel">
					...
					<fieldset>
						...
						<div class="CategoryList" id="ProductByCategoryList"></div>
					</fieldset>
			...
			{% if 'category' in tabs %}
				<div id="category_tab" class="panel">
					...
					<div class="CategoryList" id="CategoryList" style="height: 400px;"></div>
				</div>
			{% endif %}
...
<div id="ModalButtonRow">
	<input type="button" class="btn btn-cancel" value="{% lang 'Cancel' %}" onclick="$.iModal.close();" style="float: left;" />
	<input class="btn" class="Submit" type="submit" value="{% lang 'Linker_insert' %}"  onclick="$.iModal.close();"  />
</div>
