<form action="index.php?ToDo=deleteGiftWrap" name="frmGiftWrap" id="frmGiftWrap" method="post" onsubmit="return ConfirmDeleteSelected();">
	...
	<tr>
		<td class="Intro">
			...
			{{ Message|raw }}
			<p>
				<input type="button" onclick="window.location='index.php?ToDo=addGiftWrap';" value="{% lang 'AddGiftWrap' %}" class="btn" />
				<input type="submit" value="{% lang 'DeleteSelected' %}" class="btn btn-delete" {{ DisableDelete|raw }} />
			</p>
		</td>
	</tr>
	<tr>
