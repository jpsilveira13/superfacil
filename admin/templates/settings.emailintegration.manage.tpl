...
<form action="index.php?ToDo=saveUpdatedEmailIntegrationSettings" id="emailIntegrationSettingsForm" method="post">
	...
	<div id="content">
		...
		<div id="Status">{{ message|raw }}</div>

		<p class="buttonRow ">
			<input type="submit" id="" class="saveButton btn" value="Salvar">
			<input type="reset" id="" class="cancelButton btn btn-cancel" value="Cancelar">
		</p>
