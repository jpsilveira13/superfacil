	...
	<td>
		...
		<tr>
			<td class="Intro" style="padding-bottom:10px">
				<input type="button" onclick="document.location.href='index.php?ToDo=createCategory'" name="createNewCategory" value="{% lang 'CreateCategory' %}" class="btn">
				{% lang 'Or' %}
				...
				<button style="min-width: 35px;padding: 7px;" type="button" id="optionGo" class="btn" {% if not CategoryList %}disabled="disabled"{% endif %}>{% lang 'Go' %}</button>
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	<td style="padding-top: 10px;">
		<form method="post" id="frmCategories" action="index.php?ToDo=deleteCategory">
			<table class="GridPanel SortablePanel" cellspacing="0" cellpadding="0" border="0" style="border: 1px solid #ccc;border-bottom: none;width:100%; display: {{ DisplayGrid|raw }}">
				<tr class="Heading3">
