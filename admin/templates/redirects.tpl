		...
		<tr>
			<td class="Intro">
				...
				<p id="TemplateMsgBox">{{ Message|raw }}</p>
					<input type="button" id="AddNewRedirectButton" class="btn" value="{% lang 'AddNewRedirect' %}" /> <input class="btn btn-delete" type="button" id="DeleteSelectedRedirects" value="{% lang 'DeleteSelected' %}" /> <input class="btn" type="button" id="ExportRedirects" value="{% lang 'ExportRedirects' %}"> <input class="btn btn-atualize"  type="button" id="BulkImportRedirects" value="{% lang 'BulkImportRedirects' %}" /> &nbsp;<a href="#" onclick="LaunchHelp(890);">{% lang 'LearnMoreImportingRedirects' %}</a>
			</td>
		</tr>
		<tr>
			<td>
