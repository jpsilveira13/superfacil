	...
	<tr>
		<td class="Heading1">Estatísticas de Pesquisa</td>
	</tr>
	<tr>
		<td class="Intro">
	...
	<tr>
		<td class="Intro">
			<div>
				<input type="button" name="clearSearchStats" value="Deletar Estatísticas" onclick="clearStatsClick()" class="btn btn-delete" />
			</div>
		</td>
	</tr>
	<tr>
			...
			<div style="padding:5px 0px 5px 10px" class="Text FloatLeft">
				<table border=0 cellspacing=0 cellpadding=0>
					<tr>
						...
						<td style="background: #eee; padding: 3px 5px;"><input type="submit" value="Ok" class="btn" /></td>
					</tr>
				</table>
			</div>
