	...
	<tr>
		<td>
			...
			<tr>
				<td class="Heading2" colspan="2"><div class="FloatRight"><a style="color: #fff;" href="index.php?ToDo=phpSystemInfo" target="_blank">{% lang 'ViewPHPInfo' %}</a></div>{% lang 'SystemInfo' %}</td>
			</tr>
			<tr>
				<td class="FieldLabel">
					&nbsp;&nbsp; {% lang 'ProductVersion' %}:
