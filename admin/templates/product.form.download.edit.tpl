<table>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<input type="button" value="{% lang 'SaveDownload' %}" onclick="saveDownload();" class="SaveButton btn" />
			<input type="button" value="{% lang 'CancelEdit' %}" onclick="cancelDownloadEdit();" class="CancelButton btn btn-cancel" />
		</td>
	</tr>
</table>