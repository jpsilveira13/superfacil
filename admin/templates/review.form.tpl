	...
	<table class="OuterPanel">
	  <tr>
		...
		<td class="Intro">
			...
			<div><input type="submit" name="SaveButton1" value="{% lang 'Save' %}" class="btn">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()"></div>
		</td>
	  </tr>
		<tr>
			<td>
