	...
	<table class="OuterPanel">
		...
		<tr>
			<td style="padding-bottom:10px">
				<div><input type="submit" name="SubmitButton1" value="{% lang 'Export' %}" class="1">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="FormButton" onclick="ConfirmCancel()"></div>
			</td>
		</tr>
		<tr>
			<td>
