<div class="BodyContainer">
	...
	<tr>
		<td class="Intro">
			<p>
				<input type="button" value="{% lang 'DeleteSelected' %}" onclick="return Shipments.DeleteSelected();" class="btn btn-delete" {{ DisableDelete|raw }} />
				<input type="button" value="{% lang 'ExportTheseShipments' %}" onclick="Shipments.Export()" class="btn btn-atualize" {{ DisableExport|raw }} />
			</p>
		</td>
				...
				<table style="{{ DisplaySearch|raw }}">
					<tr>
						<td class="text" nowrap align="right">
							...
							<input type="submit" name="SearchButton" id="SearchButton" class="btn" value="Procurar" style="padding-left: 10px; vertical-align: top;" />
						</td>
					</tr>
					<tr>
						<td nowrap="nowrap">
