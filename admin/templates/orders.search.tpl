	...
	<table class="OuterPanel">
	  <tr>
		...
		<td class="Intro">
			...
			{{ Message|raw }}
			<p><input type="submit" name="SubmitButton1" value="{% lang 'Search' %}" class="btn">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()"></p>
		</td>
	  </tr>
		<tr>
			<td>
		...
		<tr>
			<td>
			 ...
			 <table>
				<tr>
					<td class="Gap"><input type="submit" name="SubmitButton1" value="{% lang 'Search' %}" class="btn">&nbsp; <input type="button" name="CancelButton1" value="{% lang 'Cancel' %}" class="btn btn-cancel" onclick="ConfirmCancel()">
					</td>
				</tr>
			 </table>
			</td>
