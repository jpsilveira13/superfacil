<form method="post" action="#" onsubmit="Order.SaveShipment(); return false;" id="ShipmentDetails">
	...
	<div id="ModalContent" style="min-height: 100px;overflow: auto;">
		<p class="MessageBox MessageBoxInfo">{% lang 'CreateShipmentIntro' %}</p>
		<br />
		<table class="GridPanel ShipmentTable" cellspacing="0" cellpadding="0" style="border: 1px solid #ddd;">
			<tr class="Heading3">
		...
		<table cellspacing="5" cellpadding="0" border="0" width="100%">
			<tr>
				<td class="FieldLabel" style="width:160px;">{% lang 'ShippingMethod' %}:</td>
				<td>
			...
			<tr>
				<td class="FieldLabel" style="width:160px;">{% lang 'TrackingNumber' %}:</td>
				<td>
			...
			<tr>
				<td class="FieldLabel" style="width:160px;">{% lang 'ShipmentComments' %}:</td>
				<td>
			...
			<tr>
				<td class="FieldLabel" style="width:160px;">{% lang 'OrderStatus' %}:</td>
	...
	<div id="ModalButtonRow">
		<div class="FloatLeft"><input class="btn btn-cancel" type="button" value="{% lang 'Close' %}" onclick="$.modal.close();" /></div>
		<img src="images/loading.gif" alt="" style="display: none" class="LoadingIndicator" />
		<input type="submit" class="btn" value="{% lang 'CreateShipment' %}" />
	</div>
</form>