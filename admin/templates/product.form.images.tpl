...
<div style="display:none;" id="MultiUploadDialogTemplate">
	...
	<div class="ModalButtonRow">
		<div class="MultiUploadDialogButtons">
			<div class="FloatLeft">
				<input type="button" class="CloseButton btn btn-delete" value="%closetext%" />
			</div>
			<input type="button" class="Submit btn" value="%submittext%" />
		</div>
	</div>
...
<div style="display:none;" id="UseImageFromGallery">
	...
	<div class="ModalContent">
		<div class="useImageFromGalleryHeaderRow">
			...
			<input type="button" id="ChangeImageSourceButton" class="Button FloatRight btn" style="min-width:40px;" value="{% lang 'Go' %}" />
	...
	<div class="ModalButtonRow">
		<div class="FloatLeft">
			<input type="button" class="CloseButtonbtn btn-delete" value="{% lang 'Close' %}" onclick="$.modal.close();return false;" />
		</div>
		<input type="button" class="Submit btn" value="{% lang 'UseSelectedImages' %}" id="UseSelectedImages" />
	</div>
...
<div style="display:none;" id="UseImageFromGallery">
	...
	<div class="ModalButtonRow">
		<div class="FloatLeft">
			<input type="button" class="CloseButton btn btn-delete" value="{% lang 'Close' %}" onclick="$.modal.close();return false;" />
		</div>
		<input type="button" class="Submit btn" value="{% lang 'UseSelectedImages' %}" id="UseSelectedImages" disabled="disabled" />
	</div>
</div><!-- end #UseImageFromGallery -->
