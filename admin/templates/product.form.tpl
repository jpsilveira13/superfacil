...
<script type="text/javascript" src="../javascript/jquery.stringToSlug.min.js"></script>
<script type="text/javascript">
$(document).ready( function() {
	$("#prodName").stringToSlug({
		setEvents: 'keyup keydown blur',
		getPut: '#prodMYOBIncome',
		space: ' '
	});
});
</script>
...
<div class="BodyContainer">
	...
	<tr>
		<td class="Intro">
			...
			<p>
				<input type="submit" disabled="disabled" value="{% lang 'SaveAndExit' %}" class="btn" />
				<input type="submit" disabled="disabled" value="{{ SaveAndAddAnother|raw }}" onclick="SaveAndAddAnother()" class="btn" />
		...
		<td>
				...
				<table width="100%" class="Panel">
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" id="prodMYOBIncome" name="prodMYOBIncome" value="{{ ProdMYOBIncome|raw }}" />
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
			...
			<div id="div8" style="padding-top: 10px;">
				...
				<tr>
					<td colspan="2">
						...
						<div style="margin:11px 0 6px 6px;">
							<button class="btn btn-delete" id="productImagesDeleteSelected" disabled="disabled">{% lang 'DeleteSelected' %}</button>
						</div>
						...
						<table class="GridPanel productImagesTable" cellspacing="0">
							<tbody>
								<tr class="Heading3">
									...
									<td class="productImageBaseThumb">{% lang 'UseAsBaseThumbnail' %}</td>
				...
				<tr>
					<td class="videoControlRow" colspan="2">
						<input type="text" class="Field250 exampleSearchText SetOriginalValue" id="searchYouTube" name="searchYouTube" value="{% lang 'VideoTypeToSearch' %}" /> <input type="button" class="btn" value="{% lang 'VideoFindVideos' %}" id="findVideosButton" />
					</td>
				</tr>
					...
					<td class="videoControlRow" colspan="2">
						<div id="youtubeContainer">
							...
							<div style="float:left; padding-top:95px;">
								<input type="button" class="btn btn-atualize" value="&raquo;" id="addYouTubeVideos" /><br /><br />
								<input type="button" class="btn btn-delete" value="&laquo;" id="removeYouTubeVideos" />
							</div>
			...
			<div id="div10">
				...
				<table id="googlePsForm" width="100%" class="Panel" style="margin-bottom: 0; padding-top: 0;">
					<tr>
						<td class="Heading2" colspan="2">Configurações</td>
					</tr>
					<tr>
						<td class="FieldLabel">
					...
					<tr>
						...
						<td style="padding:5px 0 0 27px;">
							{{ formBuilder.select('gender', availableGenders, gpsMappedFields.gender) }}
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
						...
						<td style="padding:5px 0 0 27px;">
							{{ formBuilder.select('ageGroup', availableAgeGroup, gpsMappedFields.age_group) }}
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
