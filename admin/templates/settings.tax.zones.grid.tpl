...
<table class="taxZonesGrid gridTable SortableGrid" cellspacing="0" cellpadding="0" style="border:1px solid #ddd; border-top: none">
	<thead>
		<tr>
			...
			<th style="width: 260px">{{ lang.Action }}</th>
		</tr>
	</thead>
	<tbody>
