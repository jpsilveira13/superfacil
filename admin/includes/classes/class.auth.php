<?php
	...
	define("AUTH_Manage_Abandoned_Orders", 200);
	...
	class ISC_ADMIN_AUTH
	{
		...
		public function HandleSTSToDo($ToDo)
		{
			...
			else if(is_numeric(isc_strpos($do, "abandoned"))) {				
				$GLOBALS['ISC_CLASS_ADMIN_ABANDONED_CART'] = GetClass('ISC_ADMIN_ABANDONED_CART');
				$GLOBALS['ISC_CLASS_ADMIN_ABANDONED_CART']->HandleToDo($ToDo);				
			}
