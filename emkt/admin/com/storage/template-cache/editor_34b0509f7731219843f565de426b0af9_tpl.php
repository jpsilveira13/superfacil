...
tinyMCE.init({
	...
	//---
	plugins : "<?php echo $tpl->Get('plugins'); ?>fullpage,safari,pagebreak,style,layer,table,save,advimage,advlink,media,searchreplace,print,contextmenu,paste,fullscreen,visualchars,nonbreaking,xhtmlxtras,template,inlinepopups,preview",
